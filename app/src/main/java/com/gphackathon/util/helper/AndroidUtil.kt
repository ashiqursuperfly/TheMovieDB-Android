...
object AndroidUtil {
    ...
    @ColorInt
    fun Context.getColorFromAttr(@AttrRes attribute: Int) = TypedValue().let { theme.resolveAttribute(attribute, it, true); it.data }

    fun setStatusBarColor(activity: Activity, statusBarColor: Int, isLight: Boolean = false) {
